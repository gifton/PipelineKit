...
@main
struct TestStressCommand: CommandPlugin {
    func performCommand(context: PluginContext, arguments: [String]) async throws {
        ...
        print("━━━━━━━━━━━━━━━━━━━━━━")
        print("")
        print("ℹ️  This runs both StressTestCore and StressTestIntegration targets.")
        print("")
        
        // Build arguments for swift test
        var args = ["test", "--filter", "StressTest"]
        
        // Stress tests should not run in parallel by default
        ...
        do {
            ...
            if process.terminationStatus == 0 {
                ...
                print("\n❌ Stress tests failed with exit code: \(process.terminationStatus)")
