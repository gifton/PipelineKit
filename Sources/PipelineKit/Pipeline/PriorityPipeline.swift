...
/// )
/// ```
public struct PriorityMiddleware: Sendable {
    ...
    /// Creates a new priority middleware wrapper.
    ///
    /// - Parameters:
    ///   - middleware: The middleware to wrap.
    ///   - priority: The priority value for execution ordering.
    public init(middleware: any Middleware, priority: Int) {
