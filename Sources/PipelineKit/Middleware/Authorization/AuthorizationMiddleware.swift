...
/// 
/// This middleware should be added with `MiddlewareOrder.authorization` priority
...
/// try await pipeline.addMiddleware(authzMiddleware, priority: MiddlewareOrder.authorization.rawValue)
/// ```
