...
extension PerformanceMiddleware {
    /// Creates a performance measurement using the shared pool
    public static func createMeasurement(
        commandName: String,
        executionTime: TimeInterval,
        isSuccess: Bool,
        errorMessage: String? = nil,
        ...
        await PerformanceMeasurementPool.shared.createMeasurement(
            commandName: commandName,
            executionTime: executionTime,
            isSuccess: isSuccess,
            errorMessage: errorMessage,
