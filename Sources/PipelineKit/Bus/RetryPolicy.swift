...
/// Marker protocol for temporary errors that should be retried.
public protocol TemporaryError: Error {}

/// Marker protocol for network-related errors that should be retried.
