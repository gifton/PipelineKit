...
public enum ExecutionPriorityExample {
    
    /// Example showing how to query middleware categories
    public static func demonstrateMiddlewareCategories() {
    ...
    public static func demonstratePriorityHelpers() {
    ...
    public static func demonstrateMiddlewareStructure() {
 ...
 */
    ...
    public static func listAllExecutionPriorities() {
    ...
    public static func runExecutionPriorityDemo() {
