...
// MARK: - Protocol Extension for Default Implementation

/// Default implementations for PipelineObserver protocol
///
/// This extension provides no-op implementations for all observer methods,
/// allowing concrete types to implement only the methods they care about.
public extension PipelineObserver {
    func pipelineWillExecute<T: Command>(_ command: T, metadata: CommandMetadata, pipelineType: String) async {
