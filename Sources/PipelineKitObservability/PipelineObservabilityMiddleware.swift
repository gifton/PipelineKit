...
public struct PipelineObservabilityMiddleware: Middleware {
    ...
    public func execute<T: Command>(
        ...
        context[ObservabilityContextKeys.observerRegistry] = observerRegistry
...
public struct ObservableMiddlewareDecorator<M: Middleware>: Middleware {
    ...
    public func execute<T: Command>(
        ...
        let observerRegistry = context[ObservabilityContextKeys.observerRegistry]
...
public struct PipelineObservabilityConfiguration: Sendable {
    ...
    public static func development() -> PipelineObservabilityConfiguration {
        if #available(macOS 11.0, iOS 14.0, watchOS 7.0, tvOS 14.0, *) {
            return PipelineObservabilityConfiguration(
                observers: [
    ...
    public static func production() -> PipelineObservabilityConfiguration {
        if #available(macOS 11.0, iOS 14.0, watchOS 7.0, tvOS 14.0, *) {
            return PipelineObservabilityConfiguration(
                observers: [
