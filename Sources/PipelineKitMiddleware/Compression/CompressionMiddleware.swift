...
public enum CompressionAlgorithm: String, Sendable, CaseIterable {
    ...
    var foundationAlgorithm: Compression.Algorithm {
        switch self {
        case .zlib: return .zlib
        case .lzfse: return .lzfse
        case .lz4: return .lz4
        case .gzip: return .zlib // Use zlib with gzip wrapper
        case .brotli: return .lzfse // Fallback, Brotli not in Foundation
        }
    }
}

/// Compression level (speed vs ratio tradeoff).
public enum CompressionLevel: String, Sendable {
