...
/// ```
///
/// Thread Safety: This type is thread-safe because all mutable state (released flag)
/// is managed through atomic operations. The unowned semaphore reference is immutable.
/// Invariant: The released flag uses atomic operations for thread-safe state transitions.
/// The semaphore must outlive all tokens as documented in the lifetime contract.
