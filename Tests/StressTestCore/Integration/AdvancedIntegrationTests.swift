...
/// Advanced integration tests demonstrating violation scheduling and leak detection.
///
/// These tests validate the advanced features from Phase A (MockSafetyMonitor+ scheduling)
/// and Phase B (ResourceLeakDetector) working together with the ScenarioTestHarness.
@MainActor
