...
final class MetricsStorageTests: XCTestCase {
    ...
    func testClear() async {
        ...
        XCTAssertEqual(await storage.count, 0)
    }
    ...
    func testTotalMetricCount() async {
        ...
        XCTAssertEqual(await storage.count, 3)
        XCTAssertEqual(await storage.uniqueMetricCount, 2)
    }
    ...
    func testTimerAggregation() async {
        ...
        XCTAssertEqual(p50?.value, 30.0, accuracy: 5.0)
    }
