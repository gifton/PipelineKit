...
final class TimeoutMiddlewareWrapperTests: XCTestCase {
    ...
    private class SlowMiddleware: Middleware {
    ...
    private class FastMiddleware: Middleware {
        let priority = ExecutionPriority.processing
    ...
    private class CountingMiddleware: Middleware {
        let priority = ExecutionPriority.processing
    ...
    func testTimeoutActuallyCancelsTask() async throws {
        ...
        do {
            ...
            XCTAssertTrue(error.middleware.contains("SlowMiddleware"))
    ...
    */
    ...
    private class ErrorThrowingMiddleware: Middleware {
        let error: Error
        let priority = ExecutionPriority.processing
    ...
    private class PriorityMiddleware: Middleware {
