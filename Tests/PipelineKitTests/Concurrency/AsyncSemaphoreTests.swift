...
// DISABLED: Temporarily disabled due to data race issues with Swift 6
// The AsyncSemaphore fix has been implemented and tested in AsyncSemaphoreCancellationTests
/*
